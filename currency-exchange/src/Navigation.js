            ...
            >
              ...
              <Nav className="ml-auto" navbar>
                <NavItem className="d-flex align-items-center">
                  <NavLink className="font-weight-bold" href="/currency-exchange/#/Ratespage" style={navStyle}> 
                  Rates Table   
                  </NavLink>
                </NavItem>
                <NavItem className="d-flex align-items-center">
                  <NavLink className="font-weight-bold" href="/currency-exchange/#/Historic" style={navStyle}>
                      Historic Lookup
                  </NavLink>
                </NavItem>
              </Nav>
